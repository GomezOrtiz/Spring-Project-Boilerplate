...
public class CodingRulesTests extends BaseArchTest {
    ...
    @ArchTest
    static final ArchRule exceptions_should_be_in_a_exceptions_package =
            classes()
    ...
    @ArchTest
    static final ArchRule custom_exceptions_should_be_final =
            classes()
                    .that().areAssignableTo(RuntimeException.class)
                    .or().resideInAPackage("..exception..")
                    .and().resideOutsideOfPackage(BASE_PACKAGE + ".application.common.exception")
